...
export default function Cta({ onStart }) {
  return (
    <section id="about" style={{ maxWidth: 1100, margin: '0 auto', padding: '96px 22px' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 'clamp(18px,2.2vw,22px)', color: 'var(--ink-600)', maxWidth: 540, margin: '22px auto 0' }}>
